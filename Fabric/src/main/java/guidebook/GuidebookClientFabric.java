...
public class GuidebookClientFabric implements ClientModInitializer {
	...
	public void onInitializeClient() {
		...
		ItemProperties.register(GuidebookItems.BOOK,
				ResourceLocation.fromNamespaceAndPath(GuidebookAPI.MOD_ID, "completion"),
				(stack, world, entity, seed) -> ItemModBook.getCompletion(stack));

		ResourceManagerHelper.get(PackType.CLIENT_RESOURCES).registerReloadListener(new IdentifiableResourceReloadListener() {
			private static final ResourceLocation id = ResourceLocation.fromNamespaceAndPath(GuidebookAPI.MOD_ID, "resource_pack_books");
		...
		ResourceManagerHelper.get(PackType.CLIENT_RESOURCES).registerReloadListener(new SimpleSynchronousResourceReloadListener() {
			private static final ResourceLocation id = ResourceLocation.fromNamespaceAndPath(GuidebookAPI.MOD_ID, "reload_hook");
