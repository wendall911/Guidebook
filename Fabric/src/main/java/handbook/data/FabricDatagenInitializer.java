...
public class FabricDatagenInitializer implements DataGeneratorEntrypoint {
    ...
    public static void configureCommonDatagen(FabricDataGenerator.Pack pack) {
        ...
        pack.addProvider((dataOutput, registryFuture) -> new HandbookItemTagsProvider(dataOutput, registryFuture, fabricBlockTagProvider.contentsGetter()));
    ...
    public static void configureFabicTestDatagen(FabricDataGenerator.Pack pack) {
        ...
        //pack.addProvider(HandbookRecipeProvider::new);
        //pack.addProvider(HandbookAdvancementProvider::new);
    }
