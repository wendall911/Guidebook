    ...
    public static void onTooltip(GuiGraphics graphics, ItemStack stack, int mouseX, int mouseY) {
        ...
        if (mc.player != null && !(mc.screen instanceof GuiBook)) {
            ...
            if (lexSlot > -1) {
                ...
                if (HandbookConfig.Client.useShiftForQuickLookup() ? Screen.hasShiftDown() : Screen.hasControlDown()) {
                ...
                graphics.drawString(mc.font, "?", x + 10, tooltipY + 8, HandbookColors.WHITE.toColor(), true);
                ...
                graphics.drawString(mc.font, key, (x + 10) * 2 - 16, (tooltipY + 8) * 2 + 20, HandbookColors.WHITE.toColor(), true);
                graphics.pose().popPose();
