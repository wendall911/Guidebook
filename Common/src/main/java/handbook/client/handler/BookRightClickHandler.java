            ...
            if (book != null) {
                ...
                if (hover != null) {
                    ...
                    if (!entry.isLocked()) {
                        ...
                        graphics.drawString(mc.font, entry.getName(), x + 18, y + 3, HandbookColors.WHITE.toColor(), false);

                        graphics.pose().pushPose();
                        graphics.pose().scale(0.75F, 0.75F, 1F);

                        graphics.drawString(mc.font, s, (int) ((x + 18) / 0.75F), (int) ((y + 14) / 0.75F), HandbookColors.GRAY.toColor(), false);
                        graphics.pose().popPose();
                    }
                }
            }
