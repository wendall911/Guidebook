...
import handbook.client.book.template.component.ComponentCustom;
import handbook.client.book.template.component.ComponentEntity;
import handbook.client.book.template.component.ComponentFrame;
import handbook.client.book.template.component.ComponentHeader;
import handbook.client.book.template.component.ComponentImage;
import handbook.client.book.template.component.ComponentItemStack;
import handbook.client.book.template.component.ComponentSeparator;
import handbook.client.book.template.component.ComponentText;
import handbook.client.book.template.component.ComponentTooltip;
...
public class BookTemplate {
	...
	static {
		...
		registerComponent(HandbookAPI.prefix("item"), ComponentItemStack.class);
		registerComponent(HandbookAPI.prefix("image"), ComponentImage.class);
		registerComponent(HandbookAPI.prefix("header"), ComponentHeader.class);
		registerComponent(HandbookAPI.prefix("separator"), ComponentSeparator.class);
		registerComponent(HandbookAPI.prefix("frame"), ComponentFrame.class);
		registerComponent(HandbookAPI.prefix("entity"), ComponentEntity.class);
		registerComponent(HandbookAPI.prefix("tooltip"), ComponentTooltip.class);
		registerComponent(HandbookAPI.prefix("custom"), ComponentCustom.class);
	}
