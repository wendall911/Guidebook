...
import handbook.client.book.gui.GuiBookCategory;
...
public class BookTextParser {
    ...
    static {
        ...
        register((parameter, state) -> {
            ...
            if (result == null) {
                state.tooltip = Component.translatable("handbook.gui.lexicon.keybind_missing", parameter);
                return "N/A";
            }

            state.tooltip = Component.translatable("handbook.gui.lexicon.keybind", Component.translatable(result.getName()));
        ...
        register((parameter, state) -> {
            ...
            if (isExternal) {
                ...
                state.tooltip = Component.translatable("handbook.gui.lexicon.external_link");
    ...
    public String expandMacros(@Nullable String text) {
        ...
        if (i == expansionCap) {
            HandbookAPI.LOGGER.warn("Expanded macros for {} iterations without reaching fixpoint, stopping. " +
