...
public class Book {
    ...
    public Book(JsonObject root, CommonModContainer owner, ResourceLocation id) {
        ...
        this.openSound = SerializationUtil.getAsResourceLocation(root, "open_sound", HandbookSounds.BOOK_OPEN.getLocation());
        this.flipSound = SerializationUtil.getAsResourceLocation(root, "flip_sound", HandbookSounds.BOOK_FLIP.getLocation());
