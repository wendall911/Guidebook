...
public class ColorHelper extends technology.roughness.whitenoise.util.ColorHelper {
    ...
    public static int getHandbookColor(String hexColor) {
    ...
    public static int fillBlack(float alpha) {
        return alphaMask(HandbookColors.BLACK.toColor(), alpha);
    }

    public enum HandbookColors {
