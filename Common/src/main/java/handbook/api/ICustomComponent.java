...
public interface ICustomComponent extends IVariablesAvailableCallback {
     ...
     */
    void render(GuiGraphicsExtractor graphics, IComponentRenderContext context, float pticks, int mouseX, int mouseY);
     ...
     */
    default boolean mouseClicked(IComponentRenderContext context, MouseButtonEvent mouseButtonEvent) {
        return false;
    }
