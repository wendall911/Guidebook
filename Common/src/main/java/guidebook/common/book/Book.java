...
public class Book {
	...
	private static final ResourceLocation DEFAULT_MODEL = ResourceLocation.fromNamespaceAndPath(GuidebookAPI.MODID, "book_brown");
	private static final ResourceLocation DEFAULT_BOOK_TEXTURE = ResourceLocation.fromNamespaceAndPath(GuidebookAPI.MODID, "textures/gui/book_brown.png");
	private static final ResourceLocation DEFAULT_FILLER_TEXTURE = ResourceLocation.fromNamespaceAndPath(GuidebookAPI.MODID, "textures/gui/page_filler.png");
	private static final ResourceLocation DEFAULT_CRAFTING_TEXTURE = ResourceLocation.fromNamespaceAndPath(GuidebookAPI.MODID, "textures/gui/crafting.png");
	...
	@Nullable public final GuidebookConfigAccess.TextOverflowMode overflowMode;
	...
	public Book(JsonObject root, CommonModContainer owner, ResourceLocation id, boolean external) {
		...
		this.overflowMode = SerializationUtil.getAsEnum(root, "text_overflow_mode", GuidebookConfigAccess.TextOverflowMode.class, null);
	...
	public final boolean advancementsEnabled() {
		return !GuidebookConfig.get().disableAdvancementLocking()
				&& !GuidebookConfig.get().noAdvancementBooks().contains(id.toString());
	}
