...
public class GuidebookConfig {
	...
	private static GuidebookConfigAccess access = null;

	public static GuidebookConfigAccess get() {
		return access;
	}

	public static void set(GuidebookConfigAccess a) {
		if (access != null) {
	...
	public static void reloadBuiltinFlags() {
		...
		setFlag("debug", IBookHelper.INSTANCE.isDevEnvironment());
