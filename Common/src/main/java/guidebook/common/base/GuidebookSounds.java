...
public class GuidebookSounds {
	...
	public static final SoundEvent BOOK_OPEN = SoundEvent.createVariableRangeEvent(ResourceLocation.fromNamespaceAndPath(GuidebookAPI.MODID, "book_open"));
	public static final SoundEvent BOOK_FLIP = SoundEvent.createVariableRangeEvent(ResourceLocation.fromNamespaceAndPath(GuidebookAPI.MODID, "book_flip"));
