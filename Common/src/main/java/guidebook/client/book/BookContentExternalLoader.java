...
import guidebook.common.book.BookFolderLoader;

/**
 * BookContentLoader that loads from the .minecraft/guidebook_books folder
 */
public final class BookContentExternalLoader implements BookContentLoader {
    ...
    private ResourceLocation relativize(File root, File f) {
        ...
        return ResourceLocation.fromNamespaceAndPath(GuidebookAPI.MODID, cleanPath);
    }
    ...
    public LoadResult loadJson(Book book, ResourceLocation file) {
        try {
            ...
            GuidebookAPI.LOGGER.warn("Failed to load {}.", file, e);
