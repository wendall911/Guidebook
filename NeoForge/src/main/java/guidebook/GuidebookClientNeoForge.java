...
import net.neoforged.neoforge.client.gui.GuidebookGuiLayers;
...
public class GuidebookClientNeoForge {
    ...
    public static void init() {
        NeoForge.EVENT_BUS.addListener(GuidebookClientNeoForge::getBookModels);
        NeoForge.EVENT_BUS.addListener(GuidebookClientNeoForge::registerReloadListeners);
        NeoForge.EVENT_BUS.addListener(GuidebookClientNeoForge::registerOverlays);
        NeoForge.EVENT_BUS.addListener(GuidebookClientNeoForge::onInitializeClient);
        NeoForge.EVENT_BUS.addListener(GuidebookClientNeoForge::replaceBookModel);
    }
	...
	public static void modelRegistry(ModelEvent.RegisterAdditional e) {
		...
		ItemProperties.register(GuidebookItems.BOOK, ResourceLocation.fromNamespaceAndPath(GuidebookAPI.MOD_ID, "completion"), prop);
	}
	...
	public static void registerOverlays(RegisterGuiLayersEvent evt) {
		evt.registerAbove(GuidebookGuiLayers.CROSSHAIR, ResourceLocation.fromNamespaceAndPath(GuidebookAPI.MOD_ID, "book_overlay"),
				BookRightClickHandler::onRenderHUD
		);
		evt.registerBelow(GuidebookGuiLayers.BOSS_OVERLAY, ResourceLocation.fromNamespaceAndPath(GuidebookAPI.MOD_ID, "multiblock_progress"),
